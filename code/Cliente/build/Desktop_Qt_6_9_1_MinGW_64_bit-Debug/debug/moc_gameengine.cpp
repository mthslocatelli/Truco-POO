...
void GameEngine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->atualizarUI(); break;
        case 1: _t->rodadaFinalizada(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (GameEngine::*)()>(_a, &GameEngine::atualizarUI, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (GameEngine::*)()>(_a, &GameEngine::rodadaFinalizada, 1))
            return;
    }
}
...
// SIGNAL 0
void GameEngine::atualizarUI()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void GameEngine::rodadaFinalizada()
{
