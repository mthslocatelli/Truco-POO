/********************************************************************************
** Form generated from reading UI file 'telapartida.ui'
**
...
#ifndef UI_TELAPARTIDA_H
#define UI_TELAPARTIDA_H
...
public:
    ...
    QPushButton *sairSala;
    QMenuBar *menubar;
    QStatusBar *statusbar;

    void setupUi(QMainWindow *TelaPartida)
    {
        if (TelaPartida->objectName().isEmpty())
            TelaPartida->setObjectName("TelaPartida");
        TelaPartida->resize(1000, 800);
        centralwidget = new QWidget(TelaPartida);
        ...
        sairSala = new QPushButton(centralwidget);
        sairSala->setObjectName("sairSala");
        sairSala->setGeometry(QRect(50, 110, 93, 29));
        QPalette palette;
        ...
        sairSala->setPalette(palette);
        sairSala->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);"));
        TelaPartida->setCentralWidget(centralwidget);
        mesa->raise();
        btnCarta1->raise();
        btnCarta2->raise();
        btnCarta3->raise();
        ...
        sairSala->raise();
        menubar = new QMenuBar(TelaPartida);
        menubar->setObjectName("menubar");
        menubar->setGeometry(QRect(0, 0, 1000, 26));
        TelaPartida->setMenuBar(menubar);
        statusbar = new QStatusBar(TelaPartida);
        statusbar->setObjectName("statusbar");
        TelaPartida->setStatusBar(statusbar);

        retranslateUi(TelaPartida);

        QMetaObject::connectSlotsByName(TelaPartida);
    } // setupUi

    void retranslateUi(QMainWindow *TelaPartida)
    {
        TelaPartida->setWindowTitle(QCoreApplication::translate("TelaPartida", "Truco Paulista", nullptr));
        btnCarta1->setText(QString());
        btnCarta2->setText(QString());
        btnCarta3->setText(QString());
        btnTruco->setText(QCoreApplication::translate("TelaPartida", "Pedir Truco", nullptr));
        lblManilha->setText(QCoreApplication::translate("TelaPartida", "Manilha:", nullptr));
        lblPontos->setText(QCoreApplication::translate("TelaPartida", "Pontos:", nullptr));
        lblTruco->setText(QCoreApplication::translate("TelaPartida", "Rodada valendo:", nullptr));
        lblMesa->setText(QCoreApplication::translate("TelaPartida", "Cartas na mesa:", nullptr));
        ...
        cartaJogador1_2->setText(QCoreApplication::translate("TelaPartida", "TextLabel", nullptr));
        cartaJogador1_3->setText(QCoreApplication::translate("TelaPartida", "TextLabel", nullptr));
        cartaJogador2_1->setText(QCoreApplication::translate("TelaPartida", "TextLabel", nullptr));
        cartaJogador2_2->setText(QCoreApplication::translate("TelaPartida", "TextLabel", nullptr));
        cartaJogador2_3->setText(QCoreApplication::translate("TelaPartida", "TextLabel", nullptr));
        cartaJogador3_1->setText(QCoreApplication::translate("TelaPartida", "TextLabel", nullptr));
        cartaJogador3_2->setText(QCoreApplication::translate("TelaPartida", "TextLabel", nullptr));
        cartaJogador3_3->setText(QCoreApplication::translate("TelaPartida", "TextLabel", nullptr));
        sairSala->setText(QCoreApplication::translate("TelaPartida", "Sair da sala", nullptr));
    } // retranslateUi

};

namespace Ui {
    class TelaPartida: public Ui_TelaPartida {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_TELAPARTIDA_H
