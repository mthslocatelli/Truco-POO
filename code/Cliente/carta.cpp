...
Carta::Carta(QString v, QString n){
    int valor_ = v.toInt();
    Naipe naipe_ = Paus;
    if(n == "paus") naipe_ = Paus;
    else if(n == "copas") naipe_ = Copas;
    else if(n == "espadas") naipe_ = Espadas;
    else if(n == "ouros") naipe_ = Ouros;
...
Carta Carta::getCarta(QString valor, QString naipe){

    int valor_ = valor.toInt(); // ou converta para int conforme seu tipo
    Naipe naipe_ = Paus;
    if(naipe == "paus") naipe_ = Paus;
    else if(naipe == "copas") naipe_ = Copas;
    else if(naipe == "espadas") naipe_ = Espadas;
    else if(naipe == "ouros") naipe_ = Ouros;
